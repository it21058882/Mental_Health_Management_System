...
Mental Health Management System </br>
Team Number - 08 </br>
Project Group - </br>
...
mental health issues and promote wellbeing. The website will comprise of a Q&A, Articles regarding mental health, Mediation, Therapies and 
downloadable books for mental health. The website will have a user management system to manage the users in the site. The website will also 
...
his input to develop the website. The website will have a soothing background music to help and calm any user that just visited the site. We 
believe that good mental health and proper well-being will raise the standards of living for people in Sri Lanka and all over the world. Because 
this website collects personal data from users, we will not sell any of the data to third parties.
